...
<script type="text/javascript">
    ...
    function goByeBye() {
        ...
        replaceTargetWith( 'visibleTitle', '<span id="visibleTitle">Processo Conclu�do</span>' );
    }
    ...
    replaceTargetWith( 'visibleTitle', '<span id="visibleTitle">Ced�ncia de Dados / Cart�es</span>' );
</script>
