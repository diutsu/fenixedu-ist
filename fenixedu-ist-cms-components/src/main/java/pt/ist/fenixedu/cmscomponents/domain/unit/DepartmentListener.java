...
import pt.ist.fenixedu.cmscomponents.domain.unit.components.CompetenceCourseComponent;
import pt.ist.fenixedu.cmscomponents.domain.unit.components.DepartmentDegrees;
import pt.ist.fenixedu.cmscomponents.domain.unit.components.DepartmentDissertationsComponent;
